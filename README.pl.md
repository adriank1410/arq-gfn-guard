...
Kolejne potwierdzone rotacje zachowują ostatni rozpoznany stan sesji, nawet gdy pierwotny wpis zniknie zarówno z logu, jak i `.bak`. Fragmenty kontrolne nowego pliku są zapisywane bez przesuwania czasu odnowienia pauzy Arq i ponownie sprawdzane po restarcie guarda. Niepowiązane kopie pozostają niewiarygodne. Ostrzeżenie o niedostępnych lub niewiarygodnych logach opisuje niepewność ich odczytu; gdy guard ma własną pauzę, informuje o dalszych próbach jej utrzymania, zamiast sugerować niepowodzenie pauzowania.
