...
Po zaobserwowaniu cofnięcia czasu w dopisanych zdarzeniach guard korzysta z tego źródła do zakończenia sesji lub procesu GFN. Po końcu sesji stare zdarzenie drugiego pliku pozostaje pomijane aż do nowego wpisu sesji; kolejne gry mogą korzystać z obu źródeł. Zachowuje ten wybór przy restarcie z aktywną pauzą. Brak tego źródła wywoła alert i podtrzymanie własnej pauzy. Cofnięcia czasu sprzed uruchomienia guarda nie da się jednoznacznie rozpoznać z logów bez strefy czasowej. Po zaobserwowanym zamknięciu GFN stare wpisy startu nie uruchamiają ponownej pauzy przy samym otwarciu launchera.
